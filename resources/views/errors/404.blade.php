                    ...
                    <div class="col-lg-10">
                        <div class="auth-logo mb-3 text-center">
                            <a href="{{ route('dashboard') }}" class="logo-dark">
                                <img src="{{ asset('images/logo-light.png') }}" height="85" alt="logo dark">
                            </a>

                            <a href="{{ route('dashboard') }}" class="logo-light">
                                <img src="{{ asset('images/logo-light.png') }}" height="24" alt="logo light">
                            </a>
                        </div>
                        ...
                        <div class="text-center">
                            <a href="{{ route('roles.index') }}" class="btn btn-primary">Back To Home</a>
                        </div>
                    </div>
                </div>
            </div>
