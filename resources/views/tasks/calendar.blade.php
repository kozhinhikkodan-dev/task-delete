...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="calendar-filters">
                                ...
                                <form id="calendar-filters" class="mt-2">
                                    ...
                                    @cannot(\App\Policies\TaskPolicy::PERMISSION_SHOW_ASSIGNED_TASKS_ONLY,
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="button" class="btn btn-primary" id="apply-filters">Apply
                                            Filters</button>
                                        <button type="button" class="btn btn-secondary" id="clear-filters">Clear
                                            Filters</button>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="modal fade" id="task-form-modal" tabindex="-1" aria-labelledby="taskFormModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form id="task-form" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="modal-customer_id" class="form-label">Select Client <span
                                                    class="text-danger">*</span></label>
                                            <select name="customer_id" id="modal-customer_id" class="form-select"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="modal-task_date" class="form-label">Task Date <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="task_date" id="modal-task_date"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="modal-task_type_id" class="form-label">Select Task Type <span
                                                    class="text-danger">*</span></label>
                                            <select name="task_type_id" id="modal-task_type_id" class="form-select"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">
                                                ...
                                                Leave empty for automatic assignment based on staff availability and
                                                workload
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="modal-status" class="form-label">Status <span
                                                    class="text-danger">*</span></label>
                                            <select name="status" id="modal-status" class="form-select" required>
                                                @foreach (\App\Models\Task::getStatusOptions() as $value => $label)
                                                    <option value="{{ $value }}"
                                                        {{ $value === 'pending' ? 'selected' : '' }}>{{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback"></div>
                                    ...
                                    <div class="col-md-6" style="display: none" id="create-form-publish-status">
                                        <div class="mb-3">
                                            <label for="status" class="form-label">Publish Status</label>
                                            <select name="publish_status" id="modal-publish-status"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="note_content" id="modal-note_content" class="form-control" rows="4"
        ...
        window.addEventListener('load', function() {
            if (window.jQuery) {
                $(document).ready(function() {
                    ...
                    document.getElementById('modal-task_type_id').addEventListener('change', function() {
                        const publishableTaskNames = @json(\App\Models\TaskType::PUBLISHABLE_TASK_TYPES);
                        const selectedValue = this.value;
                        const selectedText = this.options[this.selectedIndex].text;
                        if (publishableTaskNames.includes(selectedText)) {
